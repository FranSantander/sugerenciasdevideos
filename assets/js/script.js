...
const patronAutoEjecutable = (() => {
  ...
  let musicaVideo = new Reproductor(
    'https://www.youtube.com/embed/LrCzjsSauVQ',
    musica
  );
  let peliculasVideo = new Reproductor(
    'https://www.youtube.com/embed/918rOI1gnQ8',
    peliculas
  );
  let seriesVideo = new Reproductor(
    'https://www.youtube.com/embed/oXn6UBUUycU',
    series
  );
  ...
  musicaVideo.setInicio(102);
  peliculasVideo.setInicio(1902);
  seriesVideo.setInicio(322);